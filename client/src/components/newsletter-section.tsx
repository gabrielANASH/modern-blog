...
export default function NewsletterSection() {
  ...
  return (
    <section 
      className="py-20 bg-gradient-to-br from-electric-purple to-neon-pink"
          ...
          >
            <div className="space-y-4">
              ...
              <Button
                ...
                className="w-full px-8 py-4 bg-white text-electric-purple rounded-xl font-bold hover:bg-opacity-90 hover:scale-105 transition-all duration-300 shadow-lg disabled:opacity-50 disabled:hover:scale-100"
